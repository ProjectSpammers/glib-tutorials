...
static void
example_person_get_property(GObject *object, guint prop_id, GValue *value, GParamSpec *pspec) {
...
static void
example_person_set_property(GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec) {
    ExamplePerson *self = (ExamplePerson *) object;
    switch (prop_id) {
    case PROP_NAME:
...
example_person_class_init(ExamplePersonClass *klass) {
    ...
    properties[PROP_NAME] = g_param_spec_string("name", "Name", "The name of the person", NULL,
...
void
gobject_tutorial_get_set(int argc, char *argv[]) {
